...
@SpringBootTest(classes = com.swifteats.test.PlatformLibTestApplication.class)
...
class SampleDataImportServiceIntegrationTest {
    ...
    void importAll_loadsExpectedRowCounts() {
        Path datasetDir = importService.resolveDatasetPath("third-assignment-sample-data-set");
