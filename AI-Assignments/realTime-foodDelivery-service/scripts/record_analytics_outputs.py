#!/usr/bin/env python3
"""
Records Assignment 2 sample use case outputs from third-assignment-sample-data-set.
Mirrors AnalyticsOrderRepository + InsightGenerator logic for submission documentation.
...
def uc2(orders, fleet, warehouse_logs, clients):
    client_id = "337"
    from_dt = parse_ts("2025-04-01 00:00:00")
    to_dt = parse_ts("2025-05-01 00:00:00")
    ...
    return {
        ...
        "api": f"GET /api/v1/analytics/failures?clientId={client_id}&from=2025-04-01T00:00:00Z&to=2025-05-01T00:00:00Z",
        "narrative": narrative,
...
```bash
ANALYTICS_IMPORT_ON_STARTUP=true ANALYTICS_DEMO_ON_STARTUP=true docker compose up swifteats-api
```
